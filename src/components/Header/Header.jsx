          ...
          <div className='header'>
            ...
            <div className={ isLogin ? 'navigation-burger' : 'none' }>
              ...
              <div className={ `navigation-burger__menu ${ isMenuShown && 'active' }` }>
                ...
                <nav className={ `navigation-burger__block 
                ${ isMenuShown
                && 'active' }` }>
                  <ul className='navigation-burger__list'>
                    <div className='navigation-burger__flex'>
                      <li className={ `navigation-burger__link 
                      ${ location.pathname === '/'
                      && 'navigation-burger__link_active' } ` }>
                    ...
                    <li className={ `navigation-burger__link-account navigation-burger__link 
